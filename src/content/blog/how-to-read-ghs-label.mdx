...
| 5 | [Precautionary statements](/p-statements/) (P phrases) | What should you do? |
...
👉 Our [GHS Label Maker](/pictograms/) applies these hierarchy rules automatically when you build a label.
...
Hazard statements describe the **nature and degree of hazard** in standardised wording. Each statement has a code beginning with **H** followed by three digits. The [full list of hazard statements](/h-statements/) gives the verbatim CLP wording of every code, along with the substances that carry it.
...
Precautionary statements describe **what to do** to minimise or prevent adverse effects. P codes begin with **P** followed by three digits. Our [reference of all 117 P-codes](/p-statements/) gives the official wording for each one and shows whether it is still current under EU CLP, OSHA HazCom or the latest UN GHS.
...
- 🏷️ [GHS Label Maker](/pictograms/) — Build a complete GHS label with automatic pictogram hierarchy and P-statement optimisation
- 🔍 [UN number reference](/un/) — Transport classification of a UN number beside the GHS label elements of its substances
