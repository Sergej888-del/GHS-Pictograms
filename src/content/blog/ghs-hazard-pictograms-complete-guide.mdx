...
Below is a practical explanation of each pictogram, including what it means, example substances, and common hazard statement codes ([H-statements](/h-statements/)) associated with it. For each symbol, you can also open the dedicated pictogram page on this site.
...
- [GHS Label Maker →](/label-constructor/)

## Conclusion

GHS pictograms are the fastest way to communicate chemical hazards visually. There are **nine** official symbols, each tied to specific hazard classes and common [H-statement](/h-statements/) ranges. Correct use isn’t just about selecting the right symbol—it’s also about following CLP rules for format, size, and priority so your label stays clear and compliant. If you want a practical shortcut, use our free tool to build a compliant label based on your substance’s classification.

**Use our free GHS Label Maker to build a compliant label with the correct pictograms for your substance:** [Start here →](/label-constructor/)
