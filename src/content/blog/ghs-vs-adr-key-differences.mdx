...
👉 Open the [UN number reference](/un/) to see the ADR 2025 and 49 CFR 172.101 entries for a number side by side, with the CLP label elements of the substances that ship under it.
...
- 🔍 [UN number reference](/un/) — Look up a UN number and see the ADR and US entries beside each other, plus the GHS label elements of its substances
- 🏷️ [GHS Label Maker](/pictograms/) — Build a compliant GHS label with correct pictograms and H/P statements
...
*Have questions about GHS or ADR compliance? Look the number up in the [UN number reference](/un/).*
