...
The type criteria in B.8.2.3 and B.15.2.2 are word-for-word identical for types A through F. The pictogram allocation in [Appendix C](https://www.osha.gov/hazcom/appendix-c) lists both classes under the flame **and** both under the exploding bomb (Figure C.1). The UN's own hazard-statement codification puts self-reactive chapter 2.8 and organic-peroxide chapter 2.15 in the same cell for H241 and H242.
...
For the pictograms themselves — the exploding bomb and the flame — see [GHS01](/ghs/ghs01/) and [GHS02](/ghs/ghs02/).
