...
**Practical tip:** the ATE values you put here are what your downstream user will plug into mixture classification software. The [ATE Calculator](/tools/ate-mixture-calculator/) shows how those numbers flow into final mixture classification.
...
**Practical tip:** the LD50 and LC50 numbers here flow into mixture classification calculations. For mixtures, the ATE values from supplier SDS power downstream classification — see how on the [ATE Calculator](/tools/ate-mixture-calculator/). For substances, the toxicology entry at [ghssymbols.com/hazards/](https://ghssymbols.com/hazards/) mirrors the data the supplier should report.
