...
In the EU, classification follows the CLP Regulation (EC No 1272/2008), which sets the hazard classes and categories, while REACH Annex II governs how the resulting information is laid out on the sheet. For mixtures, calculating an acute toxicity estimate (ATE) is a common step; an [ATE calculator](/tools/ate-mixture-calculator/) and a reference for [hazard classes and statements](/substances/) help keep this stage accurate.
