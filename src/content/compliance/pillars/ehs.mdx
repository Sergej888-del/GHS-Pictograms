...
- Related tools: the [GHS Pictogram Selector](/pictogram-selector/) and [GHS Label Maker](/label-constructor/) on this site, and the [substance hazard database](https://ghssymbols.com/hazards/) and [ATE calculator](https://ghssymbols.com/tools/ate-calculator/) on ghssymbols.com.
...
If you are working through a specific substance, the [substance hazard database](https://ghssymbols.com/hazards/) on ghssymbols.com gives you the classification and hazard statements that feed an assessment, and the [ATE calculator](https://ghssymbols.com/tools/ate-calculator/) helps with acute-toxicity classification for mixtures. On this site, the [GHS Pictogram Selector](/pictogram-selector/) and [GHS Label Maker](/label-constructor/) turn that classification into compliant pictogram sets and labels. EHS is what you do with all of it once the chemicals are in your building.
