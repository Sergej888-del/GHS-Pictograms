...
For practical mixture classification supporting SDS Section 3 content, the [ATE Calculator](/tools/ate-mixture-calculator/) computes acute toxicity estimates from Annex VI and component data.
...
- [ATE Calculator — compute acute toxicity estimates for SDS Section 3](/tools/ate-mixture-calculator/)
