...
- [GHS Label Maker — generate CLP-compliant labels matching SDS Section 2](https://ghspictograms.com/ghs-label-maker/)
- [Substance Database — CAS-indexed CLP Annex VI classifications for SDS authoring](/substances/)
