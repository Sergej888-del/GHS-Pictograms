...
- **Related tools:** [ATE Calculator](https://ghssymbols.com/ate-calculator/) · [H-Statements](/h-statements/) · [Storage Segregation](https://ghssymbols.com/storage-segregation/) · [Label Maker](https://ghspictograms.com/label-constructor/).
...
A substance is an SVHC if it is classified under the [CLP Regulation](/compliance/clp/) as Carcinogenic Category 1A or 1B (Article 57 a), Mutagenic Category 1A or 1B (b), or Reproductive Toxicant Category 1A or 1B (c). These are substances assigned the [hazard codes H340 (germ-cell mutagenicity), H350 (carcinogenicity), or H360 (reproductive toxicity)](/h-statements/) at category 1A or 1B level — either through harmonised classification in Annex VI of CLP or through self-classification supported by available data.
...
The SDS should also include the [hazard statements (H-codes)](/h-statements/) and [precautionary statements (P-codes)](/p-statements/) reflecting the substance's full classification. Where the substance triggers Annex XIV-style controls, the SDS exposure scenarios should anticipate the eventual authorisation requirements.
