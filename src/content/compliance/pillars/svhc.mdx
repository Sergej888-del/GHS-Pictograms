...
relatedPages:
  ...
  - "/compliance/sds/"
  - "/compliance/un-ghs/"
  - "/compliance/svhc/scip-database-notification-guide/"
crossDomainLinks:
...
- [SCIP Database Notification Guide: Requirements & Process](/compliance/svhc/scip-database-notification-guide/) — how EU suppliers notify ECHA about SVHCs in articles, the IUCLID submission process, national enforcement variations, and the December 2025 repeal proposal

For the broader REACH framework that governs SVHC identification, see the [REACH Compliance Guide](/compliance/reach/) and the [REACH Registration Step-by-Step](/compliance/reach/reach-registration-step-by-step/) cluster article, which covers the registration mechanism that feeds substance hazard data into the SVHC identification process.
