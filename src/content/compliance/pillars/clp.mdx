...
For practical classification of mixtures, the [ATE Calculator](/tools/ate-mixture-calculator/) implements CLP's acute toxicity estimate methodology in line with Annex I, Part 3.
...
- [ATE Calculator — classify mixtures by acute toxicity estimate](/tools/ate-mixture-calculator/)
