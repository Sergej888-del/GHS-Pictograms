...
**Annex VI — Harmonised classification and labelling for certain hazardous substances.** The legally binding list of substances with mandatory classifications (the CLH list, also called Table 3 of Part 3). This is the annex most frequently updated through ATPs — currently at the 22nd ATP, effective 1 May 2026. The CLH list is what the [GHS substance database](/substances/) on this site is built from.
...
The [GHS Label Maker](https://ghspictograms.com/ghs-label-maker/) generates CLP-compliant labels with all required elements automatically.
...
- [GHS Label Maker — generate CLP-compliant labels](https://ghspictograms.com/ghs-label-maker/)
- [Substance Database — CAS-indexed CLP Annex VI classifications](/substances/)
