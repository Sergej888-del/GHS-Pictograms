...
**Annex III — List of hazard statements.** The full catalogue of standardized hazard phrases, each coded with the letter "H" plus three digits. CLP follows UN GHS H-codes and adds EU-specific EUH codes for hazards not in the UN system. See the [complete list of hazard statements](/h-statements/) — every code with its verbatim Annex III wording and its status under CLP, OSHA HazCom and the current UN GHS.

**Annex IV — List of precautionary statements.** Codified P-codes covering general, prevention, response, storage, and disposal precautions. See the [full list of P-codes with the verbatim Annex IV wording](/p-statements/).
...
**[Precautionary statements](/p-statements/) (P-codes).** Drawn from Annex IV, covering general, prevention, response, storage, and disposal measures. The 2024 revision caps the number of P-statements per label at six (with limited exceptions for high-hazard products).
...
The [GHS Label Maker](https://ghspictograms.com/label-constructor/) generates CLP-compliant labels with all required elements automatically.
...
- [GHS Label Maker — generate CLP-compliant labels](https://ghspictograms.com/label-constructor/)
