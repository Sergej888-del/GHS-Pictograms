...
For SVG downloads and detailed pictogram reference pages with hazard class mappings, signal words, and example substances, see our [GHS pictogram library](/pictograms/). For a substance-specific lookup that returns the pictograms required for a given chemical, see the [substance hazard database](/substances/).
