...
**3. Hazard statements.** Standardized phrases coded with the letter "H" plus three digits. The first digit indicates the hazard type — **2** for physical, **3** for health, **4** for environmental. Examples: [H220](/h-statements/H220/) ("Extremely flammable gas"), [H350](/h-statements/H350/) ("May cause cancer"), [H410](/h-statements/H410/) ("Very toxic to aquatic life with long-lasting effects"). The [full catalogue](/h-statements/) shows each code across nine GHS editions. The current GHS catalogues roughly 72 individual hazard statements plus 17 combined statements.
