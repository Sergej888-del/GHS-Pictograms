...
For substance-specific harmonized classifications and CAS-indexed hazard data, the [Substance Database](/substances/) provides access to EU CLP Annex VI entries, the most authoritative harmonized classification dataset in active regulatory use.
