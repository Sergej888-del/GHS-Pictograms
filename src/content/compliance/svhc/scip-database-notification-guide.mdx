...
**[GHS Label Maker](/ghs-label-maker/)** — generates CLP-compliant labels with the correct pictograms, signal word, and hazard statements for products containing SVHCs and other classified substances. Useful when an article also requires a supply label under CLP.
