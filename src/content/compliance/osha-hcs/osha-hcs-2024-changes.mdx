...
- **Related tools:** [ATE Calculator](/tools/ate-mixture-calculator/) · [GHS Label Maker](https://ghspictograms.com/label-constructor/)
...
For SDS workflows that involve mixture reclassification ahead of the November 2027 deadline, our [ATE Calculator](/tools/ate-mixture-calculator/) computes acute toxicity estimates from component data using GHS Rev 7 arithmetic.

---

<SdsManagerCard service="authoring" body="Re-issuing a catalogue of safety data sheets against a fixed deadline is the case authoring software is built for: classification updated once to GHS Rev. 7, all 16 sections regenerated from it, and every affected sheet reissued with a new Section 16 revision date. The solution we recommend is SDS Manager (ExactSDS). It also offers SDS management and a broader EHS suite." href="https://sdsmanager.com/us/sds-authoring?fpr=ghs3&fp_sid=gposha" />
...
**GHS Label Maker** generates fully compliant container labels with correct pictogram sizing for all five CLP volume tiers, which match the practical packaging sizes used by U.S. manufacturers. [→ Open Label Maker](https://ghspictograms.com/label-constructor/)

**ATE Calculator** computes acute toxicity estimates from component data — essential for the November 2027 mixture reclassification deadline. The calculator uses the same arithmetic specified in GHS Rev 7 Annex 9 and outputs a printable summary. [→ Open ATE Calculator](/tools/ate-mixture-calculator/)
...
- [GHS Label Maker for HCS 2024 Labels](https://ghspictograms.com/label-constructor/)
- [ATE Calculator for Mixture Classification](/tools/ate-mixture-calculator/)
