...
- **The chemical-safety spine:** every audit check reads back to the SDS, the substance's classification and the inventory. Look up any substance in the [substance hazard database](/substances/).
