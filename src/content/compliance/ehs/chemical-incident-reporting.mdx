...
- **The chemical-safety spine:** the SDS drives the response — Section 4 (first aid), Section 5 (firefighting) and Section 6 (accidental release) — and the substance's classification often decides whether an injury or illness is recordable at all. Look up any substance in the [substance hazard database](/substances/).
...
For the underlying classification that determines whether a health effect is recordable, the [SDS pillar](/compliance/sds/) explains the 16-section structure, and the [substance hazard database](/substances/) provides the per-substance hazard data.
