...
For label updates triggered by the new harmonised classifications, our [GHS Label Maker](https://ghspictograms.com/ghs-label-maker/) generates fully compliant labels at all five CLP volume tiers with correct pictogram sizing.
...
- [GHS Label Maker](https://ghspictograms.com/ghs-label-maker/) — generate CLP-compliant labels at all five volume tiers
- [ATE Calculator](/tools/ate-mixture-calculator/) — GHS Rev 7 acute toxicity arithmetic for mixture classification
