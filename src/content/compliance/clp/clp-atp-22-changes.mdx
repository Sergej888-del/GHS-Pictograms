...
For label updates triggered by the new harmonised classifications, our [GHS Label Maker](https://ghspictograms.com/label-constructor/) generates fully compliant labels at all five CLP volume tiers with correct pictogram sizing.
...
- [GHS Label Maker](https://ghspictograms.com/label-constructor/) — generate CLP-compliant labels at all five volume tiers
