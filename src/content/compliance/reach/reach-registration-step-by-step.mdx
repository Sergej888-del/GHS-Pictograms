...
A typical inquiry takes a few weeks to resolve. Practically, this is also when you start building the [substance information needed for the technical dossier](/substances/) — physico-chemical properties, hazard data, intended uses — even though you do not yet have access to the joint registration data.
...
Cross-domain tools: substance-by-substance hazard data on the [substance database](/substances/), and the [Label Maker](https://ghspictograms.com/ghs-label-maker/) for building CLP-compliant labels once your classification is settled.
