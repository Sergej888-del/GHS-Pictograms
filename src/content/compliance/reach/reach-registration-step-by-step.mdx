...
Cross-domain tools: substance-by-substance hazard data on the [substance database](/substances/), and the [Label Maker](https://ghspictograms.com/label-constructor/) for building CLP-compliant labels once your classification is settled.
