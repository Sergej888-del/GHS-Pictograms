...
Cross-domain tools: substance-by-substance hazard data on the [GHS Symbols substance database](https://ghssymbols.com/hazards/), and the [Label Maker](https://ghspictograms.com/label-constructor/) for building CLP-compliant labels once your classification is settled.
