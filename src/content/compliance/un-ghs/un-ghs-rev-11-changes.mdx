...
- **Related tools:** [Label Maker](https://ghspictograms.com/ghs-label-maker/) · [ATE Calculator](/tools/ate-mixture-calculator/)
...
For mixture classification work that depends on Annex 9 arithmetic, our [ATE Calculator](/tools/ate-mixture-calculator/) implements the GHS Rev 7 formulas; Rev 11 has not changed the underlying ATE arithmetic.
...
For label updates that are required — particularly for the [22nd ATP to CLP](https://echa.europa.eu/information-on-chemicals/annex-vi-to-clp), which became applicable May 1, 2026 in the EU — our [GHS Label Maker](https://ghspictograms.com/ghs-label-maker/) generates compliant labels at all five CLP volume tiers.
...
- [GHS Label Maker](https://ghspictograms.com/ghs-label-maker/) — generate CLP-compliant labels at correct pictogram sizes
- [ATE Calculator](/tools/ate-mixture-calculator/) — GHS Rev 7 acute toxicity estimate arithmetic for mixtures
