...
For label updates that are required — particularly for the [22nd ATP to CLP](https://echa.europa.eu/information-on-chemicals/annex-vi-to-clp), which became applicable May 1, 2026 in the EU — our [GHS Label Constructor](https://ghspictograms.com/label-constructor/) generates compliant labels at all five CLP volume tiers.
...
- [GHS Label Constructor](https://ghspictograms.com/label-constructor/) — generate CLP-compliant labels at correct pictogram sizes
